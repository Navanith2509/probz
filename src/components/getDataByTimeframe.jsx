...
const  getDataByTimeframe=(timeframe)=> {
  ...
  // Implement logic to filter or aggregate data based on timeframe
  if (timeframe === 'weekly') {
    return groupByWeek(jsonData);
  } else if (timeframe === 'monthly') {
    return groupByMonth(jsonData);
  } else {
    // Handle daily timeframe (no grouping)
    return jsonData;
  }
}
...
export default getDataByTimeframe
